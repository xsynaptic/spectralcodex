import { ephemera } from '#lib/collections/ephemera/config.ts';
import { images } from '#lib/collections/images/config.ts';
import { locations } from '#lib/collections/locations/config.ts';
