...
const translationStrings = {
	[defaultLanguage]: {
		// Homepage
		'index.introduction': `Welcome to **Spectral Codex**, a travel journal, photography portfolio, geospatial database, digital garden, and personal blog curated by Alexander Synaptic. This site is completely ad-free and features no sponsored content, though you're welcome to support my work via [Patreon](https://www.patreon.com/spectralcodex) if you like what you find here. Read a little more about my background and motivations [here](/about), or start browsing the collection!`,
